...
const AddUser = () => {
    ...
    return (
        <div className="relative">
            <Brucrums text1={'Home'} text2={'Users'} text3={'Add Users'} />
            <div className='p-4'>
                <div className='flex flex-col my-6 gap-6'>
                    {["Fullname", "Email", "Mobile Numbers", "Password"].map((label, index) => (
                ...
                <button onClick={handleOpenModal} className='w-full my-3 text-white py-3 rounded-lg bg-blue-600'>Add User</button>
            </div>
            ...
            {modal === 1 && (
                <div className="fixed  inset-0 flex items-center justify-center backdrop-blur-md  p-6  bg-opacity-30">
                    <div className="bg-white p-6 rounded-lg shadow-lg text-center">
                        <p className="text-md font-semibold mb-4">Are you sure you want to create this user?</p>
            ...
            {modal === 2 && (
                <div className="fixed  inset-0 flex items-center justify-center backdrop-blur-md  p-6  bg-opacity-30">
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        <p className="text-lg font-semibold text-center">User Added Successfully</p>
                    </div>
                </div>
            )}
        </div>
